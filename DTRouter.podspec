...
Pod::Spec.new do |s|
  s.name             = 'DTRouter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DTRouter.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/jinqiucheng1006@live.cn/DTRouter.git', :tag => s.version.to_s }
